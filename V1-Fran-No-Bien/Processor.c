...
void Processor_DecodeAndExecuteInstruction() {
	...
	switch (operationCode) {
		...
		//Instruction MEMADD
        case MEMADD_INST: //Realiza la suma del valor de op1 y el contenido del memAddress y deja el resultado en el acumulador
			...
			registerCTRL_CPU=CTRLREAD;
			Buses_write_ControlBus_From_To(CPU,MMU);
			// Copiamos el valor leido en el acumullador y le sumamos op1.
