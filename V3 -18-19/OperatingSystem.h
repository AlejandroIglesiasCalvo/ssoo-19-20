...
{
	SYSCALL_END = 3,
	SYSCALL_YIELD = 4, // V1 Ejercicio 12
	SYSCALL_PRINTEXECPID = 5,
	SYSCALL_SLEEP = 7 // V2 Ejercicio 5d
};
...
typedef struct
{
	...
	char *name;			   // V1 Ejercicio 10
	int queueID;		   // V1 Ejercicio 11a
	int copyOfAccumulator; // V1 Ejercicio 13
	int whenToWakeUp;	  // V2 Ejercicio 5a
} PCB;
...
int OperatingSystem_GetExecutingProcessID(); // V3 Ejercicio 1
